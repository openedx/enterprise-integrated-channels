"""
Tests for the `channel_integrations.cornerstone.models` models module.
"""
...
class TestCornerstoneEnterpriseCustomerConfiguration(unittest.TestCase):
    ...
    @freeze_time(NOW)
    @mock.patch(
        'channel_integrations.cornerstone.models.CornerstoneEnterpriseCustomerConfiguration.get_learner_data_exporter'
    )
    def test_transmit_single_learner_data(self, mock_learner_exporter):
        ...
        with mock.patch(
                'channel_integrations.cornerstone.models.CornerstoneEnterpriseCustomerConfiguration'
