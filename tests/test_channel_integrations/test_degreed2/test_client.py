...
class TestDegreed2ApiClient(unittest.TestCase):
    ...
    @mock.patch('channel_integrations.degreed2.client.Degreed2APIClient._get')
    ...
    @responses.activate
    @mock.patch('channel_integrations.degreed2.client.Degreed2APIClient.fetch_degreed_course_id')
    @mock.patch('enterprise.api_client.client.JwtBuilder', mock.Mock())
