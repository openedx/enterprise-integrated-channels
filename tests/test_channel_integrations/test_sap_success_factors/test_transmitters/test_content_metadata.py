...
class TestSapSuccessFactorsContentMetadataTransmitter(unittest.TestCase):
    ...
    @responses.activate
    @mock.patch('channel_integrations.sap_success_factors.client.SAPSuccessFactorsAPIClient.create_content_metadata')
    ...
    @responses.activate
    @mock.patch('channel_integrations.sap_success_factors.client.SAPSuccessFactorsAPIClient.delete_content_metadata')
    @mock.patch('channel_integrations.sap_success_factors.client.SAPSuccessFactorsAPIClient.update_content_metadata')
    @mock.patch('channel_integrations.sap_success_factors.client.SAPSuccessFactorsAPIClient.create_content_metadata')
    ...
    @mock.patch('channel_integrations.utils.LOGGER')
