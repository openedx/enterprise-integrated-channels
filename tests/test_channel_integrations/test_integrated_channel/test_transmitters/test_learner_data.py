...
class TestLearnerDataTransmitter(unittest.TestCase):
    ...
    @mock.patch("channel_integrations.utils.is_already_transmitted")
    ...
    @mock.patch("channel_integrations.integrated_channel.models.LearnerDataTransmissionAudit")
    @mock.patch("channel_integrations.utils.is_already_transmitted")
    def test_learner_data_transmission_dry_run_mode(self, already_transmitted_mock,
                                                    learner_data_transmission_audit_mock):
        """
