...
class TestContentMetadataTransmitter(unittest.TestCase):
    ...
    def setUp(self):
        ...
        create_content_metadata_mock = mock.patch(
            'channel_integrations.integrated_channel.client.IntegratedChannelApiClient.create_content_metadata'
        )
        ...
        update_content_metadata_mock = mock.patch(
            'channel_integrations.integrated_channel.client.IntegratedChannelApiClient.update_content_metadata'
        )
        ...
        delete_content_metadata_mock = mock.patch(
            'channel_integrations.integrated_channel.client.IntegratedChannelApiClient.delete_content_metadata'
        )
