...
from channel_integrations.lms_utils import get_course_certificate, get_course_details, get_single_user_grade
...
class TestLMSUtils(unittest.TestCase):
    ...
    @mock.patch('channel_integrations.lms_utils.get_certificate_for_user')
    ...
    @mock.patch('channel_integrations.lms_utils.CourseGradeFactory')
    ...
    @mock.patch('channel_integrations.lms_utils.CourseOverview')
