...
from channel_integrations.blackboard.transmitters import learner_data
...
class TestBlackboardLearnerDataTransmitter(unittest.TestCase):
    ...
    def setUp(self):
        ...
        assessment_reporting_mock = mock.patch(
            'channel_integrations.blackboard.client.BlackboardAPIClient.create_assessment_reporting'
        )
        ...
        create_course_completion_mock = mock.patch(
            'channel_integrations.blackboard.client.BlackboardAPIClient.create_course_completion'
        )
