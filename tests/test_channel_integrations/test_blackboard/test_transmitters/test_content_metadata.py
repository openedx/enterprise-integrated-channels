...
class TestBlackboardContentMetadataTransmitter(unittest.TestCase):
    ...
    @responses.activate
    @mock.patch('channel_integrations.blackboard.client.BlackboardAPIClient.create_content_metadata')
    @mock.patch('channel_integrations.blackboard.client.BlackboardAPIClient.delete_content_metadata')
    @mock.patch('channel_integrations.blackboard.client.BlackboardAPIClient.update_content_metadata')
