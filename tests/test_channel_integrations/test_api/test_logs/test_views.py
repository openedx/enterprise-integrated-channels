"""
Tests for the `channel_integrations` content and learner sync api.
"""
import datetime
import math
...
class ContentSyncStatusViewSetTests(APITest):
    ...
    # @ddt.data('CANVAS_CHANNEL', 'BLACKBOARD', 'CSOD', 'DEGREED2', 'MOODLE', 'SAP')
...
class LearnerSyncStatusViewSetTests(APITest):
    ...
    def test_gets_of_all_channels(self):
        app_labels = ['CANVAS_CHANNEL', 'BLACKBOARD_CHANNEL', 'CSOD', 'DEGREED2_CHANNEL', 'MOODLE_CHANNEL', 'SAP']
        self.setup_admin_user(True)
...
class IntegratedChannelsBaseViewSetTests(APITest):
    ...
    def setUp(self):
        ...
        self.degreed2_content_transmission_1 = factories.ContentMetadataItemTransmissionFactory(
            enterprise_customer=self.enterprise_customer,
            content_title='course-v1:edX+DemoX+DemoCourse3',
            integrated_channel_code=self.degreed2_config.channel_code(),
            plugin_configuration_id=self.degreed2_config.id,
            api_response_status_code='200',
            channel_metadata={},
        ...
        self.degreed2_content_transmission_2 = factories.ContentMetadataItemTransmissionFactory(
            enterprise_customer=self.enterprise_customer,
