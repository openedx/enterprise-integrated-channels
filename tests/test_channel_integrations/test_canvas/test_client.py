...
class TestCanvasApiClient(unittest.TestCase):
    ...
    @mock.patch('channel_integrations.canvas.client.refresh_session_if_expired', lambda x: ('mock session', 30))
    ...
    @mock.patch('channel_integrations.canvas.client.refresh_session_if_expired', _raise_ClientError)
