...
from channel_integrations.canvas.transmitters import learner_data
...
class TestCanvasLearnerDataTransmitter(unittest.TestCase):
    ...
    def setUp(self):
        ...
        assessment_reporting_mock = mock.patch(
            'channel_integrations.canvas.client.CanvasAPIClient.create_assessment_reporting'
        )
        ...
        create_course_completion_mock = mock.patch(
            'channel_integrations.canvas.client.CanvasAPIClient.create_course_completion'
        )
