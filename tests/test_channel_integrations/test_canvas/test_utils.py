"""
Tests for utils in channel_integrations.canvas.
"""
import copy
import datetime
import random
...
from channel_integrations.utils import refresh_session_if_expired
...
class TestCanvasUtils(unittest.TestCase):
    ...
    @mock.patch('channel_integrations.canvas.utils.CanvasUtil.find_course_in_account')
    @mock.patch('channel_integrations.canvas.utils.CanvasUtil.find_root_canvas_account')
