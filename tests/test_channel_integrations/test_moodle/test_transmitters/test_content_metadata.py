...
class TestMoodleContentMetadataTransmitter(unittest.TestCase):
    ...
    @responses.activate
    @mock.patch('channel_integrations.moodle.client.MoodleAPIClient.create_content_metadata')
    @mock.patch('channel_integrations.moodle.client.MoodleAPIClient.delete_content_metadata')
    @mock.patch('channel_integrations.moodle.client.MoodleAPIClient.update_content_metadata')
