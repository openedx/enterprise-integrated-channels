...
class TestLearnerExporter(unittest.TestCase):
    ...
    @mock.patch('channel_integrations.integrated_channel.exporters.learner_data.GradesApiClient')
    @mock.patch('channel_integrations.integrated_channel.exporters.learner_data.get_course_details')
    ...
    @mock.patch('channel_integrations.integrated_channel.exporters.learner_data.get_course_details')
    @mock.patch('enterprise.api_client.discovery.CourseCatalogApiServiceClient')
    @mock.patch('channel_integrations.integrated_channel.exporters.learner_data.get_course_certificate')
    @mock.patch('channel_integrations.integrated_channel.exporters.learner_data.get_persistent_grade')
    @mock.patch('channel_integrations.integrated_channel.exporters.learner_data.get_single_user_grade')
    ...
    @mock.patch('channel_integrations.integrated_channel.exporters.learner_data.get_persistent_grade')
    @mock.patch('channel_integrations.integrated_channel.exporters.learner_data.get_course_certificate')
    @mock.patch('channel_integrations.integrated_channel.exporters.learner_data.get_completion_summary')
    @mock.patch('channel_integrations.integrated_channel.exporters.learner_data.is_course_completed')
    @mock.patch('enterprise.api_client.discovery.CourseCatalogApiServiceClient')
    ...
    @mock.patch('channel_integrations.integrated_channel.exporters.learner_data.get_course_id_for_enrollment')
