...
extract_translations: ## extract strings to be translated, outputting .mo files
	rm -rf docs/_build
	cd enterprise_integrated_channels && i18n_tool extract --no-segment

compile_translations: ## compile translation files, outputting .po files for each supported language
	cd enterprise_integrated_channels && i18n_tool generate

detect_changed_source_translations:
	cd enterprise_integrated_channels && i18n_tool changed
...
pull_translations:
	find enterprise_integrated_channels/conf/locale -mindepth 1 -maxdepth 1 -type d -exec rm -r {} \;
	atlas pull $(OPENEDX_ATLAS_ARGS) translations/enterprise-integrated-channels/enterprise_integrated_channels/conf/locale:enterprise_integrated_channels/conf/locale
...
dummy_translations: ## generate dummy translation (.po) files
	cd enterprise_integrated_channels && i18n_tool dummy
