...
from channel_integrations.degreed.exporters.content_metadata import DegreedContentMetadataExporter
from channel_integrations.degreed.exporters.learner_data import DegreedLearnerExporter
from channel_integrations.degreed.transmitters.content_metadata import DegreedContentMetadataTransmitter
from channel_integrations.degreed.transmitters.learner_data import DegreedLearnerTransmitter
...
class DegreedGlobalConfiguration(ConfigurationModel):
    ...
    changed_by = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name='degreed_channel_global_configurations',
        help_text="The user who last changed this configuration."
    )
...
class DegreedEnterpriseCustomerConfiguration(EnterpriseCustomerPluginConfiguration):
    ...
    enterprise_customer = models.ForeignKey(
        EnterpriseCustomer,
        related_name='degreed_enterprise_customer_configurations',
