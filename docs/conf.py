...
"""
enterprise-integrated-channels documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'enterprise-integrated-channels',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/openedx/enterprise-integrated-channels",
...
#
# html_title = 'enterprise-integrated-channels v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'An integrated channel is an abstraction meant to represent a third-party system which provides an API that can be used to transmit EdX data to the third-party system.',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'enterprise_integrated_channels'),
                os.path.join(root_path, 'enterprise_integrated_channels/migrations')])
